            ...
            <div className="flex flex-wrap gap-2">
              {COMPAT_ROWS.map((row) => (
                ...
                >
                  {row.icon} {row.tech}
                  {row.tooltip && (
                    <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-1.5 bg-terminal text-term text-[11px] rounded-lg whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-10 border border-white/10">
                      {row.tooltip}
                    </span>
                  )}
                </span>
